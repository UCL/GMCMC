...
static void test_gamma52() {
  ...
  //   fprintf('CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf_2nd_order(gamma, %.15f), %.15f, 1.0e-07);\n', x, y.d2x);
  // end
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf(gamma, 19.710196458528475), -4.574343608134036, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf_1st_order(gamma, 19.710196458528475), -0.297059354105564, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf_2nd_order(gamma, 19.710196458528475), -0.010296226439013, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf(gamma, 13.575885602598271), -2.998552128636525, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf_1st_order(gamma, 13.575885602598271), -0.205359921474703, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf_2nd_order(gamma, 13.575885602598271), -0.021703193968348, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf(gamma, 4.746827768665336), -2.787297390410021, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf_1st_order(gamma, 4.746827768665336), 0.342668029037143, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf_2nd_order(gamma, 4.746827768665336), -0.177522351790336, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf(gamma, 10.893280403588752), -2.537845445341222, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf_1st_order(gamma, 10.893280403588752), -0.132801153389734, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf_2nd_order(gamma, 10.893280403588752), -0.033708748237977, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf(gamma, 29.544739113301027), -7.872536511352370, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf_1st_order(gamma, 29.544739113301027), -0.364612106248073, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf_2nd_order(gamma, 29.544739113301027), -0.004582470443646, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf(gamma, 9.063547159636419), -2.358521064345489, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf_1st_order(gamma, 9.063547159636419), -0.058671684546025, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf_2nd_order(gamma, 9.063547159636419), -0.048692670505361, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf(gamma, 8.475490876723510), -2.332820882923309, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf_1st_order(gamma, 8.475490876723510), -0.028050934372979, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf_2nd_order(gamma, 8.475490876723510), -0.055683980136554, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf(gamma, 17.362387897335104), -3.907758675964633, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf_1st_order(gamma, 17.362387897335104), -0.269616943035010, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf_2nd_order(gamma, 17.362387897335104), -0.013269088234133, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf(gamma, 16.892860474988737), -3.782655668371527, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf_1st_order(gamma, 16.892860474988737), -0.263213577361731, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf_2nd_order(gamma, 16.892860474988737), -0.014016952486457, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf(gamma, 5.028041550015748), -2.697688290474991, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf_1st_order(gamma, 5.028041550015748), 0.295538374178207, 1.0e-07);
  CU_ASSERT_DOUBLE_EQUAL_REL(gmcmc_distribution_log_pdf_2nd_order(gamma, 5.028041550015748), -0.158220326197526, 1.0e-07);
