...
int main(int argc, char * argv[]) {
  ...
  const char * param_names[] = { "K_+1", "K_-1", "K_+2", "K_-2", "Beta_1", "Alpha_1", "Beta_2", "Alpha_2", "K*_+2" };
  ...
  // tensors)
  // Either 'fixed'
  int * blocks = malloc(9 * sizeof(int));
  blocks[0] = 0; blocks[1] = 1; blocks[2] = 2; blocks[3] = 3; blocks[4] = 4;
  blocks[5] = 5; blocks[6] = 6; blocks[7] = 7; blocks[8] = 8;
