#!/bin/sh
#
# PBS qsub script for Frequency 20Hz stochastic eye model using Metropolis Hastings
#
...
mpiexec ${HOME}/GMCMC/Eye_all_MH --dataset ${HOME}/GMCMC/data/Eye_Data/Frequency/MacroC20Hz_BC.h5 --ph_data ${HOME}/GMCMC/data/Eye_Data/Frequency/WNBG05_20Hz_BC.txt ${HOME}/GMCMC/results/Frequency_20Hz_BurnIn.h5 ${HOME}/GMCMC/results/Frequency_20Hz_Posterior.h5
