...
mpiexec ${HOME}/GMCMC/ION_FiveState_Balanced_PopMCMC -t16 ${HOME}/results/ION_FiveState_Balanced_PopMCMC_BurnIn.h5 ${HOME}/results/ION_FiveState_Balanced_PopMCMC_Posterior.h5
