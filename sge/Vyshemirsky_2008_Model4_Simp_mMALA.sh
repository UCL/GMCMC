...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./Vyshemirsky_2008_Model4_Benchmark_1_Simp_mMALA results/Vyshemirsky_2008_Model4_Benchmark_1_Simp_mMALA_${NSLOTS}_${i}
exit 0
