#!/bin/bash
#
# Generic SGE qsub script for stochastic eye models using Metropolis Hastings.
#
...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./Eye_all_MH --dataset ${DATASET} --ph_data ${INPUT_DATA} results/Eye_all_MH_BurnIn.h5 results/Eye_all_MH_Posterior.h5
