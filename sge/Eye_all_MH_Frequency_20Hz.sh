#!/bin/bash
#
# SGE qsub script for Frequency 20Hz stochastic eye model using Metropolis Hastings.
#
...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./Eye_all_MH --dataset data/Eye_Data/Frequency/MacroC20Hz_BC.h5 --ph_data data/Eye_Data/Frequency/WNBG05_20Hz_BC.txt results/Frequency_20Hz_BurnIn.h5 results/Frequency_20Hz_Posterior.h5
exit 0
