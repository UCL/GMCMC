...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./ION_FiveState_Balanced_PopMCMC --num_temperatures=100 --num_posterior_samples=20000 results/ION_FiveState_Balanced_${NSLOTS}_${i}
exit 0
