#!/bin/bash
#
# SGE qsub script for Five State Balanced ion channel model using Metropolis Hastings.
#
...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./ION_FiveState_Balanced_PopMCMC results/ION_FiveState_Balanced_BurnIn.h5 results/ION_FiveState_Balanced_Posterior.h5
