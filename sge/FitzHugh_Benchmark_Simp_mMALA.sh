#!/bin/bash
#
# SGE qsub script for FitzHugh Nagumo ODE model using Simplified mMALA.
#
...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./FitzHugh_Benchmark_Simp_mMALA results/FitzHugh_Simp_mMALA_BurnIn.h5 results/FitzHugh_Simp_mMALA_Posterior.h5
