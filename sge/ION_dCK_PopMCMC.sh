...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./ION_dCK_PopMCMC --num_temperatures=50 --num_posterior_samples=20000 results/ION_dCK_${NSLOTS}_${i}
exit 0
