#!/bin/bash
#
# SGE qsub script for Castillo Katz ion channel model using Metropolis Hastings.
#
...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./ION_dCK_PopMCMC results/ION_dCK_BurnIn.h5 results/ION_dCK_Posterior.h5
