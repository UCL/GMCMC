#!/bin/bash
#
# SGE qsub script for Vlad's ODE model using Metropolis Hastings.
#
...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./Vyshemirsky_2008_Model4_Benchmark_1_MH results/V2008M4_MH_BurnIn.h5 results/V2008M4_MH_Posterior.h5
