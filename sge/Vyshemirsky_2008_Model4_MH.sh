...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./Vyshemirsky_2008_Model4_Benchmark_1_MH results/Vyshemirsky_2008_Model4_Benchmark_1_MH_${NSLOTS}_${i}
exit 0
