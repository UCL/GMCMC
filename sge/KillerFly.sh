#!/bin/bash
#
# SGE qsub script for KillerFly stochastic eye model using Metropolis Hastings.
#
...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./Eye_all_MH --dataset data/Eye_Data/Animal/KillerFly/BG1_MacroCKillerFly_BC.h5 --ph_data data/Eye_Data/Animal/KillerFly/BG1_NSPa2s5msinter_30k_BC.txt results/KillerFly_BurnIn.h5 results/KillerFly_Posterior.h5
