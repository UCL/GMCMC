...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./ION_FiveState_PopMCMC --num_temperatures=100 --num_burn_in_samples=5000 --num_posterior_samples=100000 results/ION_FiveState_${NSLOTS}_${i}
exit 0
