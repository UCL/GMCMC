#!/bin/bash
#
# SGE qsub script for Vlad's ODE model using Simplified mMALA with a truncated proposal.
#
...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./Vyshemirsky_2008_Model4_Benchmark_1_Simp_mMALA_trunc results/V2008M4_Simp_mMALA_trunc_BurnIn.h5 results/V2008M4_Simp_mMALA_trunc_Posterior.h5
