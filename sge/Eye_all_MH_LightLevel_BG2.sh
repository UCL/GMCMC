#!/bin/bash
#
# SGE qsub script for LightLevel BG2 stochastic eye model using Metropolis Hastings.
#
...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./Eye_all_MH --dataset data/Eye_Data/LightLevel/BG2_MacroC_30k_500Hz_BC.h5 --ph_data data/Eye_Data/LightLevel/BG2_WNlight_30k_500Hz_BC.txt results/LightLevel_BG2_BurnIn.h5 results/LightLevel_BG2_Posterior.h5
