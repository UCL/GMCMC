#!/bin/bash
#
# SGE qsub script for Locke ODE model using Simplified mMALA.
#
...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./Locke_Benchmark_Simp_mMALA results/Locke_Simp_mMALA_BurnIn.h5 results/Locke_Simp_mMALA_Posterior.h5
