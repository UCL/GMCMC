...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./Locke_Benchmark_Simp_mMALA --num_temperatures=100 --num_posterior_samples=10000 results/Locke_Benchmark_Simp_mMALA_${NSLOTS}_${i}
exit 0
