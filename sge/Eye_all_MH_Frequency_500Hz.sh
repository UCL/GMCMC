#!/bin/bash
#
# SGE qsub script for Frequency 500Hz stochastic eye model using Metropolis Hastings.
#
...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./Eye_all_MH --dataset data/Eye_Data/Frequency/MacroC500Hz_BC.h5 --ph_data data/Eye_Data/Frequency/WNBG05_500Hz_BC.txt results/Frequency_500Hz_BurnIn.h5 results/Frequency_500Hz_Posterior.h5
exit 0
