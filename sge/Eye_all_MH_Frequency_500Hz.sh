...
${MPI_ROOT}/bin/mpirun --mca btl_tcp_if_exclude lo,eth0 -n ${NSLOTS} ./Eye_all_MH --num_temperatures=100 --num_burn_in_samples=5000 --num_posterior_samples=50000 --dataset data/Eye_Data/Frequency/MacroC500Hz_BC.mat data/Eye_Data/Frequency/WNBG05_500Hz_BC.txt results/Frequency_500Hz
exit 0
